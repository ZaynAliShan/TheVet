...
router.post(
    ...
    body("licenceNumber", "LiscenceNumber must contain atleast 5 Characters.").isLength({ min: 5 }),
    body("experience", "Experince cannot be empty.").exists().isFloat({ min: 0, max: 50 }).withMessage('Experince must be between 0 and 50'),
